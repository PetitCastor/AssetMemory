...
using AssetMemory.Standalone.Components;
...
internal static class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        // already-running UI instead of crashing on a port collision. Shared mutex name with
        // AssetMemory.UI on purpose -- the two editions are alternate packagings of the same app
        // and shouldn't run side by side against the same %LOCALAPPDATA%\AssetMemory data.
